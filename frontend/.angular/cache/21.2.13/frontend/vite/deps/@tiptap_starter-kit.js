import {
  Link
} from "./chunk-UYJPYNXL.js";
import {
  Dropcursor,
  Gapcursor,
  TrailingNode,
  UndoRedo
} from "./chunk-QDTMOLML.js";
import {
  Underline
} from "./chunk-W7BNJSAE.js";
import {
  Extension,
  Fragment,
  Mark,
...
var h = (tag, attributes) => {
  ...
  const _a = attributes != null ? attributes : {}, { children } = _a, rest = __objRest(_a, ["children"]);
  if (tag === "svg") {
    throw new Error(
...
var Blockquote = Node3.create({
  ...
  renderHTML({ HTMLAttributes }) {
    return h("blockquote", __spreadProps(__spreadValues({}, mergeAttributes(this.options.HTMLAttributes, HTMLAttributes)), { children: h("slot", {}) }));
  },
...
var Bold = Mark.create({
  ...
  renderHTML({ HTMLAttributes }) {
    return h("strong", __spreadProps(__spreadValues({}, mergeAttributes(this.options.HTMLAttributes, HTMLAttributes)), { children: h("slot", {}) }));
  },
...
var Heading = Node3.create({
  ...
  addKeyboardShortcuts() {
    return this.options.levels.reduce(
      (items, level) => __spreadProps(__spreadValues({}, items), {
...
var OrderedList = Node3.create({
  ...
  renderHTML({ HTMLAttributes }) {
    const _a = HTMLAttributes, { start, type } = _a, attributesWithoutType = __objRest(_a, ["start", "type"]);
